...
//    }
     ...
     * @throws IOException
     */
    public void fileCopy(String sourceContainerName, String sourceDirectory,
            String sourceFileName, String targetContainerName,
            String targetDirectory, String targetFileName) {
        Resource source = getResource(sourceContainerName, sourceDirectory,
                sourceFileName);
        WritableResource target = getResource(targetContainerName, targetDirectory,
                targetFileName);
...
//     * @return
//     */
//    public AmazonS3URI getAzureStorageAccountURI(Resource resource) {
//        try {
...
//
     ...
     * @throws IOException
     */
    public Resource[] fileSearch(String containerName, String directory,
            String pattern) {
        try {
